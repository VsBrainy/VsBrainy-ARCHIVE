function onUpdate(elapsed)
	...
	noteTweenX(defaultPlayerStrumX3, 4, defaultPlayerStrumX3 - 390 + (1280/2)*math.sin((currentBeat+10*1.5)*math.pi), 1.35)
	noteTweenX(defaultPlayerStrumX1, 5, defaultPlayerStrumX1 - 390 + (1280/2)*math.sin((currentBeat+10*1.5)*math.pi), 1.35)
	...
	noteTweenX(defaultOpponentStrumX3, 0, defaultOpponentStrumX3 + 390 - (1280/2)*math.sin((currentBeat+10*1.5)*math.pi), 1.35)
	noteTweenX(defaultOpponentStrumX1, 1, defaultOpponentStrumX1 + 390 - (1280/2)*math.sin((currentBeat+10*1.5)*math.pi), 1.35)
