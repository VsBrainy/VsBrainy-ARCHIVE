...
class Achievements {
	...
	{
		createAchievement('brainy', {name: "Brainy", description: "Beat Brainy's week"});
		createAchievement('week1_nomiss', {name: "Overthink", description: "Beat Brainy's week without misses"});

		createAchievement('skid03', {name: "SKiD03", description: "Beat SKiD03's week"});
		createAchievement('week2_nomiss', {name: "Overthink", description: "Beat SKiD03's week without misses"});

		createAchievement('minisynth', {name: "MiniSynth", description: "Find a secret."});

		createAchievement("perfect", {name: "Perfect!!", description: "Beat a song with zero misses!"});
